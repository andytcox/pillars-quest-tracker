...
class QuestsControllerTest < ActionController::TestCase
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post :create, quest: { location: @quest.location, name: @quest.name, notes: @quest.notes, person: @quest.person }
    end
  ...
  test "should update quest" do
    patch :update, id: @quest, quest: { location: @quest.location, name: @quest.name, notes: @quest.notes, person: @quest.person }
    assert_redirected_to quest_path(assigns(:quest))
  end
